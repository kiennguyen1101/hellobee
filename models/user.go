...
type User struct {
	...
	Password  string    `boil:"password" json:"password" toml:"password" yaml:"password" json:"-"`
	IsAdmin   uint8     `boil:"is_admin" json:"is_admin" toml:"is_admin" yaml:"is_admin"`
...
var (
	userColumns               = []string{"ID", "username", "email", "password", "is_admin", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "email", "password"}
	userColumnsWithDefault    = []string{"ID", "is_admin", "created_at", "updated_at"}
