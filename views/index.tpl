 <header id="header" class="hero is-light">
    <div class="hero-head">
...
{{ if eq "dev" (getConfigString "runmode")  }}
  <script src="/static/js/reload.min.js"></script>
{{end}}
 <link type="text/css" rel="stylesheet" href="{{getAsset "index.css"}}" />
 <script src="{{getAsset "application.js"}}"></script>